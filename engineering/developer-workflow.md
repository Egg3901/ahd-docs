...
For **AI-specific** investigation, validation, and handoff conventions, see [ai-development-workflow.md](./ai-development-workflow.md). For codebase structure, see [repo-operating-map.md](./repo-operating-map.md). The authoritative rules for code and git live in `AGENTS.md` at the repo root.
